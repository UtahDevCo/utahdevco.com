    ...
    <section className="flex flex-col items-center justify-center gap-10 pt-5 sm:pt-10 pb-10">
      <div className="flex flex-col items-center justify-center gap-4">
        ...
        <p className="text-sm sm:text-base text-center">
          Strike the balance between <br /> <b>cost</b>, <b>quality</b>, and{" "}
          <b>speed to market</b>
        </p>
      </div>
  ...
  return (
    <section className="flex flex-col sm:flex-row items-stretch justify-center gap-5 p-5 bg-secondary">
      {heroes.map((hero) => (
        ...
        >
          <h2 className="text-2xl sm:text-3xl font-bold py-1 px-0">
            {hero.title}
          </h2>
...
function CTA() {
  return (
    <section className="flex flex-col items-center justify-center gap-10 py-5 sm:py-10 px-4">
      <div className="flex flex-col items-center justify-center gap-4">
        <h2 className="text-2xl sm:text-3xl font-bold py-1 px-2">
          Let&apos;s Talk
        </h2>
        <p className="text-sm sm:text-base text-center">
...
async function Portfolio() {
  const portfolioProjects = await getDocuments("portfolio-projects", [
    "title",
    "coverImage",
    "content",
  ]);
  ...
  return (
    <section className="flex flex-col items-center justify-center gap-10 w-full py-3 sm:py-5 px-4 bg-secondary text-secondary-foreground">
      <h2
        className={clsx(
          righteous.className,
          "text-4xl sm:text-6xl font-bold pt-2 px-2"
        )}
      >
        Portfolio
      </h2>
      {portfolioProjects.map((project) => {
        return (
          ...
          >
            ...
            <ReadMore
              className="mdx relative z-10 flex flex-col gap-4"
              maxHeight={200}
            >
...
function Footer() {
  return (
    <footer className="flex flex-col sm:flex-row items-center justify-between gap-5 px-4 py-5 w-full">
      <NextImage
        alt="UtahDevCo logo"
        src="/images/logos/udc-logo-square.svg"
        width={100}
        height={100}
      />
